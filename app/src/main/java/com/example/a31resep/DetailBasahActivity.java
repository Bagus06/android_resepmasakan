...
public class DetailBasahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_basah);

        Basah diterima = getIntent().getParcelableExtra("kunci");
